...
export const TERMS_SECTIONS = [
  ...
  {title:"Who you're agreeing with",  body:"Centsible is currently operated by Austin Lai, an individual, as an independent, unincorporated project — not a registered company. By using the app, you're agreeing with that individual, not a corporation."},
